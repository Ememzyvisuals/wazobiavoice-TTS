...
from wazobiavoice_tts.tts import WazobiaVoiceTTS
...
model = WazobiaVoiceTTS.from_pretrained(device=device)

text = "Ezreal and Jinx teamed up with Ahri, Yasuo, and Teemo to take down the enemy's Nexus in an epic late-game pentakill."
wav = model.generate(text)
ta.save("test-1.wav", wav, model.sr)

multilingual_model = WazobiaVoiceMultilingualTTS.from_pretrained(device=device)
