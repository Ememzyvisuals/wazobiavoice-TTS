...
import torch
import gradio as gr
from wazobiavoice_tts.tts_turbo import WazobiaVoiceTurboTTS
...
def load_model():
    print(f"Loading WazobiaVoice-Turbo on {DEVICE}...")
    model = WazobiaVoiceTurboTTS.from_pretrained(DEVICE)
    return model
...
with gr.Blocks(title="WazobiaVoice Turbo", css=CUSTOM_CSS) as demo:
    gr.Markdown("# ⚡ WazobiaVoice Turbo")
